...
/**
 * <code>AbstractBlock</code> is the basic implementation of 
...
private void fireBlockChangeEvent(BlockChangeEvent e) {
  ...
  /**
   * Set the block ID of this block (USE INTERNALLY BY <code>BlockTableModel</code>)
   */
   ...
   * @param x The x position relative to top left corner.
   * @param y The y position relative to top left corner.
   */  
