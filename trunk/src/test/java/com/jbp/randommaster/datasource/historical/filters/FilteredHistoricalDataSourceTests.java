...
public class FilteredHistoricalDataSourceTests extends TestCase {
	...
	public void testLoad20121009() {
		...
		try (HkDerivativesTRHDF5Source originalSrc=new HkDerivativesTRHDF5Source(inputHDF5Filename, LocalDate.of(2012,10,9), "Futures",  "HSI");
				FilteredHistoricalDataSource<HkDerivativesTR> src = 
						new FilteredHistoricalDataSource<HkDerivativesTR>(originalSrc, new ExpiryMonthFilter<HkDerivativesTR>(YearMonth.of(2012,10)));) {
