...
public class HkDerivativesTRHDF5SourceTests extends TestCase {
	...
	public void testLoad2Files() {
		...
		HkDerivativesTR expectedRow1 = new HkDerivativesTR("HSI", "F", YearMonth.of(2013, 3), 0.0, "",
				LocalDateTime.parse("2013-03-01T09:14:02.000"), 22909.0, 1.0, "020");
		HkDerivativesTR expectedRow1108244 = new HkDerivativesTR("HSI", "F", YearMonth.of(2013, 4), 0.0, "",
				LocalDateTime.parse("2013-03-28T16:14:59.000"), 22316.0, 1.0, "001");
		HkDerivativesTR expectedRow1108245 = new HkDerivativesTR("HSI", "F", YearMonth.of(2013, 4), 0.0, "",
				LocalDateTime.parse("2013-04-02T09:14:00.000"), 22100.0, 4.0, "020");
		HkDerivativesTR expectedRow2243750 = new HkDerivativesTR("HSI", "F", YearMonth.of(2013, 5), 0.0, "",
	...
	public void testLoad20121009() {
		...
		try (HkDerivativesTRHDF5Source src = new HkDerivativesTRHDF5Source(inputHDF5Filename, LocalDate.of(2012, 10, 9), "Futures", "HSI")) {
			HkDerivativesTR expected20000 = new HkDerivativesTR("HSI", "F", YearMonth.of(2012, 10), 0.0, "",
