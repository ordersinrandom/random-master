...
java -Xmx1300m -cp %cp%  com.jbp.randommaster.applications.hkex.trfile.HkDerivativesTRFile2HDF5  ..\..\quant.trading.data\HkDerivativesTRFiles ..\..\quant.trading.data\HkDerivativesTRHDF5
