 ...
 */
package com.jbp.randommaster.gui.common.date.calendar;
...
public class JDateChooser extends JPanel implements ActionListener, PropertyChangeListener, ChangeListener {
	...
	private static final long serialVersionUID = -4449744869899927901L;
    ...
    /**
     * Additional implementation to handle the enable/disable UI refresh.
     */
     ...
     * @param b
     */
    public void setWeekOfYearVisible(boolean b) {
      if (jcalendar!=null)
        jcalendar.setWeekOfYearVisible(b);
    }
