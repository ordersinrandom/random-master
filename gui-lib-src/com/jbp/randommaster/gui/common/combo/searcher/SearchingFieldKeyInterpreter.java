...
public class SearchingFieldKeyInterpreter {
  
  public static boolean isUpOrDownKey(KeyEvent e) {
  ...
  public static boolean isValidInput(KeyEvent e) {
    Collection invalidInput=new HashSet();
    
    return !invalidInput.contains(new Integer(e.getKeyCode()));
  }
